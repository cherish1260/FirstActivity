...
public class ForthActivity extends Activity implements View.OnClickListener {
    ...
    private static final String TAG = "ForthActivity—Fragment";
    ...
    private void initData() {
        ...
        fragmentTransaction.replace(R.id.v_content, fragmentOne);
        ...
        switch(v.getId()) {
            ...
            case R.id.btn_two:
                if (fragmentTwo.isAdded()) {
                    fragmentTransaction.replace(R.id.v_content, fragmentTwo);
                } else {
                    fragmentTransaction.replace(R.id.v_content, fragmentTwo);
                    fragmentTransaction.addToBackStack(null);
                }
